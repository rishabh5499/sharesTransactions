...
public class longTermList extends AppCompatActivity {
...
//        Toast.makeText(getApplicationContext(), srcStr, Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            miscFuns.showAlert(longTermList.this, "No data in DB");
        }
...
//        add.setVisibility(View.GONE);
            ...
            db.orderByChild("date").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        miscFuns.showAlert(longTermList.this, "No Records");
                    }
                }
    ...
    private boolean forwardIntent(String selectedItem, @NonNull String srcStr) {
        ...
        switch (srcStr){
            case "Purchases":
            case "Sale":
                add = new Intent(longTermList.this, stockMarketTrxn.class);
...
//        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        Intent myIntent = new Intent(longTermList.this, MainActivity.class);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if(retValue ==1) {
                    ...
                    miscFuns.showAlert(longTermList.this, "Error");
                    registerReceiver(broadcastReceiver, new IntentFilter(ConnectivityManager.CONNECTIVITY_ACTION));
                    Intent back = new Intent(longTermList.this, MainActivity.class);
                    startActivity(back);
                }
            }
        },2000);
